...
class gsAPI{
    ...
    */
    public function authenticateUser(gsUser $user){
        // if session not set and can't create one, return false
        if (!$this->session){
        ...
        // now we have session
        // if (no username AND no email) OR no token, return false
        // meaning we need username or email and token to work
